                ...
                >
                    ...
                    >
                        <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }} className="w-full sm:w-auto">
                            <Link href="/mods&skins" className="group px-8 md:px-10 py-4 md:py-5 bg-linear-to-r from-cyan-500 to-blue-600 text-black font-extrabold rounded-2xl flex items-center justify-center gap-3 text-lg transition-all shadow-lg shadow-cyan-500/25">
                        ...
                        <motion.div whileHover={{ x: 5 }} className="w-full sm:w-auto">
                            <Link
                                href="https://www.facebook.com/groups/986541809388996/?ref=share_group_link&rdid=I9JOBODJZ7c2SXxE&share_url=https%3A%2F%2Fwww.facebook.com%2Fshare%2Fg%2F1CamGefVsB#"
                                target="_blank"
                                rel="noopener noreferrer"
                                className="group px-8 md:px-10 py-4 md:py-5 border-2 border-slate-800 hover:border-slate-600 hover:bg-[#1877F2]/10 text-white font-bold rounded-2xl flex items-center justify-center gap-3 text-lg transition-all"
                            >
                                <Facebook className="w-6 h-6 text-[#1877F2] fill-[#1877F2]/20 group-hover:scale-110 transition-transform" />

                                Join Community
                                <FiArrowRight className="text-xl group-hover:translate-x-1 opacity-50 group-hover:opacity-100 transition-all" />
                            </Link>
                        </motion.div>
                    </motion.div>
                </motion.div>
